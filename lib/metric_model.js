    ...
    yaml: (doc) => {
        ...
        if (object.sloViolations) {
            const processSloViolations = (violations) => {
                ...
                let combinedConstraint = buildConstraint(JSON.parse(doc['sloViolations']));
            ...
            let violations=[]
            object.sloViolations.forEach(sloViolation => {
                violations.push(...processSloViolations(sloViolation))
            })
            object.sloViolations = violations
        }
