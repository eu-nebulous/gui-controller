...
container.on('message', (context)=>{
    ...
    if (context.message.address === "eu.nebulouscloud.eu.user.get") {
        ...
        const message = {
            ...
            body: {
               username: "[your application nonce]",
               organization:"[your application id]",
               role: "[role]"
            }
        }
...
container.on('connection_open', function (context) {
    ...
    sender_ui_application_info = context.connection.open_sender('topic://eu.nebulouscloud.eu.user.app.reply');
